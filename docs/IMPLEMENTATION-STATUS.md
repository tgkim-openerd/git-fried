...
작성: 2026-04-30 / 갱신: 2026-05-06 Sprint c31 22 + c32 3 + c33 14 + c34 5 + c35 6 + c36 4 + c37 11 + c38 5 + c39 1 + c40 11 + c40 후속 4 + c40 후속 (전체) 3 + c40 review-fix 6 + c40+ /analyze 2차 3 + c41 /analyze 1~6 자율 4 + **c42 추가 자율 2** = 104 commit / 트리거: c42 — c41 후속 자율 발굴 → c42-1 storage 5 migration smoke +2 (cargo 208→210) / c42-2 i18n 잔여 50+ 중 37+ 마이그 (generic errors/toast 그룹 도입, 21 파일, ko/en 803→838 line) / c42-3 forge mock HTTP 보류 (mockito 단독 sprint)
...
| **i18n 기초 인프라** | ✅ **활성화** (vue-i18n **11.4.0** + **ko/en 838 line 완전 대칭** + 50+ 컴포넌트·composable 활용) | **c42 +33 신규 키** (generic 그룹 도입 — `errors.*` 25 + `toast.*` 확장 8). 21 파일 / 37+ 위치 1차 마이그 (App.vue / pages / 9 컴포넌트 / 7 composables). c41 +67 키 (TagPanel/BranchPanel/InteractiveRebase/CommitDetail/CommitInput/CommitDiffModal). c40+ +18 (window.prompt 9건). c40: vue-i18n ^9 → ^11. c38 +64 키. c39: missingWarn/fallbackWarn DEV 모드 ON |
