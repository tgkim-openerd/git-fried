...
작성: 2026-04-30 / 갱신: 2026-05-05 Sprint c31 22 + c32 3 + c33 14 + c34 5 + c35 6 + c36 4 + c37 11 + c38 5 + c39 1 + c40 11 + c40 후속 4 + c40 후속 (전체) 3 + c40 review-fix 6 + c40+ /analyze 2차 3 + **c41 /analyze 1~6 자율 4** = 102 commit / 트리거: `/analyze` 1~6 자율 진행 → #1·#2 이미 c38 후속 완료 확인 / #3 forge·storage unit test +13 (cargo 195→208) / #4 i18n 6 컴포넌트 100% (TagPanel·BranchPanel·InteractiveRebaseModal·CommitDetailSidebar·CommitMessageInput·CommitDiffModal — 63건 / 67 신규 키, ko·en 732→803 line 대칭) / #5·#6 보류
...
| **테스트** | ✅ **vitest 60 / 660 tests** / cargo test **208/208** / **E2E 10 spec / 신규 15 tests** / bench compile | **c41 cargo +13** (forge/model 4 + forge/github 3 + forge/gitea 3 + storage/db 3 — serde 가드 + sync helper + DbExt CRUD round-trip). c40 review-fix: cargo +10. c40 후속 (전체): e2e/settings.spec.ts (6). c40 후속: e2e/repositories.spec.ts (3 — Clone Modal a11y). c40: stash + worktree (3+3). c38 +16 / c39 +7 / c37 +48 누적 |
...
| **i18n 기초 인프라** | ✅ **활성화** (vue-i18n **11.4.0** + **ko/en 803 line 완전 대칭** + 31+ 컴포넌트 활용) | **c41 +67 신규 키** (TagPanel/BranchPanel toast 20 + InteractiveRebase·CommitDetail·CommitInput 27 + CommitDiffModal template 16 + window.prompt promptDialog migration 4 잔여) — ko/en 732→803 line 대칭. c40+ +18 (window.prompt 9건 마이그). c40: vue-i18n ^9 → ^11 + StashPanel/RepoSpecificForm 8건. c38 +64 키. c39: missingWarn/fallbackWarn DEV 모드 ON |
